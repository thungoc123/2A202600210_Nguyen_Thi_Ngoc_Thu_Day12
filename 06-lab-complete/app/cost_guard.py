...
# Hàm tiện ích cho main.py
def check_and_record_cost(input_tokens: int, output_tokens: int, user_id: str = "default"):
    """
    Kiểm tra budget và ghi nhận usage cho user (hoặc global nếu không có user_id).
    Gọi trước khi gửi LLM (input), và sau khi nhận kết quả (output).
    """
